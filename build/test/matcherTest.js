...
const initDevices = (topAdminAccount, blockchainProperties) => __awaiter(this, void 0, void 0, function* () {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        for (let j = 0; j < 3; j++) {
            ...
            const generatedAsset = yield ewf_coo_1.ProducingAsset.CREATE_ASSET(producingAssetProps, blockchainProperties);
    ...
    for (let i = 0; i < 3; i++) {
        ...
        const consumingAsset = yield ewf_coo_1.ConsumingAsset.CREATE_ASSET(consumingAssetProps, blockchainProperties);
        //   console.log("generating consuming asset #" + consumingAsset.id)
        generatedConsumingAssets.push(consumingAsset);
    }
});
const initDemands = (topAdminAccount, blockchainProperties) => __awaiter(this, void 0, void 0, function* () {
   ...
   */
        testamount++;
        let currentDemand = yield ewf_coo_1.Demand.CREATE_DEMAND(demandProps, blockchainProperties, topAdminAccount);
        return currentDemand;
    }
});
describe('Test Matcher', () => __awaiter(this, void 0, void 0, function* () {
    let topAdminAccount;
    let blockchainProperties;
    it('should create new assets', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const cooContractInstance = new web3.eth.Contract(ewf_coo_1.CoOTruffleBuild.abi, "0x3251af4228147ae39e60619f9e021d09bcd10fcc");
        ...
        yield initDevices(topAdminAccount, blockchainProperties);
        chai_1.expect(generatedProducingAssets.length).to.equal(9);
        chai_1.expect(generatedConsumingAssets.length).to.equal(3);
    })).timeout(7500);
    for (let i = 0; i < 256; i++) {
        it('should create new demand #' + i, () => __awaiter(this, void 0, void 0, function* () {
            let matchingPossible = true;
            let createdDemand = yield initDemands(topAdminAccount.address, blockchainProperties);
            if (!createdDemand)
                return true;
            const asset = generatedProducingAssets.find((a) => a.id === createdDemand.productingAsset);
            for (let j = 0; j < 8; j++) {
            ...
            if (matchingPossible)
                console.log("should have matched");
        })).timeout(5000);
    }
}));
//# sourceMappingURL=matcherTest.js.map